...
export default function Home() {
  return (
    <>
      <MaxWidthWrapper className="mb-12 mt-28 text-center sm:mt-40 flex flex-col  justify-center items-center">
        <div className="mx-auto mb-4 flex  max-w-fit items-center justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50">
          <p className="text-sm font-semibold text-gray-700">
            Chat With Document is Now Public
          </p>
        </div>
        ...
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">It allwos you to have conversations with any PDF document. Simply 
        upload your file and start asking questions righ away.
        </p>

        <Link 
          className={buttonVariants({
            size:'lg',
            className:"mt-5"  //custom property
          })} 
          href={'/dashboard'} 
          target='_blank'>
        ...
        <div className="mx-auto mb-32 mt-32 max-w-5xl sm:mt-56">
          <div className="mb-12 px-6 lg:px-8">
            <div className="mx-auto max-w-2xl sm:text-center">
              <h2 className="mt-2 font-bold text-wxl text-gray-900 sm:text-5xl">Start chatting in minutes</h2>
              <p className="mt-4 text-lg text-gray-600">
                chatting with your PDF files has never been easier than with MohitPDF,
              </p>
            </div>
          </div>
          ...
          <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
              ...
              <li className="md:flex-1">
                <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    We&apos;s that simple. Try out MohitPDF today-it really takes less than a minute.
                  </span>
                </div>
              </li>
