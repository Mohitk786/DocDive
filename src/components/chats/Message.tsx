...
interface MessageProps {
    message: ExtendedMessages    //checkout types folder waha se aaya hai ye => ExtendedMessages
            ...
            <div className={cn(`relative flex h-6 w-6 aspect-square items-center justify-center`, {
            ...
            })}>
                {
                    message.isUserMessage  ? (
                        <Icons.user className="fill-zinc-200 text-zinc-200 h-3/4 w-3/4"/> //user logo chat
                    ) : (
                        <Icons.logo className="fill-zinc-200 text-zinc-200 h-3/4 w-3/4"/> //ai logo on chat
                    )
                }
            </div>
            <div 
                ...
                >
                    ...
                    >
                    {
                        typeof message.text === "string" ? ( //markdown only renders string so we performed a checked
                            <ReactMarkdown className={cn("props",{
