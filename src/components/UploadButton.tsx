...
const UploadDropzone = ({isSubscribed}:{isSubscribed:boolean}) => {
    ...
    const startSimulatedProgress = () => {
        ...
        // har 500 milliseconds k baad 5% badha do progress bar ko
    ...
    return (
        <Dropzone 
            ...
            setIsUploading(true)
            const progressInterval:any = startSimulatedProgress()
                        ...
                        > 
                            ...
                            { isUploading ? (
                                <div className="w-full mt-4 max-w-xs mx-auto">
                                    ...
                                    {uploadProgress === 100 ? (
                                        <div className="flex gap-1 items-center text-sm text-zinc-700 justify-center text-center pt-2">
